...
<div class="container">
	<form>
	  ...
	  <div class="mb-3">
	    <label for="exampleInputEmail1" class="form-label"><strong>Número de Matrícula</strong></label>
	  ...
	  <div class="mb-3">
	    ...
	    <input type="number" class="form-control" name="endereço" id="exampleInputEmail1" aria-describedby="emailHelp">
	  </div>
	  ...
	  <label for="exampleInputEmail1" class="form-label"><strong>Modalidade do Cliente</strong></label>
	  					<select name="personType" class="form-select" aria-label="Default select example">
							...
							<option name="personType" value="Juridica">Pessoa Jurídica</option>
						</select>
	  </div>
